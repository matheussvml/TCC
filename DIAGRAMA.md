...
flowchart TB
    ...
    UI -->|2. POST /api/transcribe| Proxy
...
flowchart LR
    ...
    Cleanup --> Response([Retorna JSON:<br/>title, thumbnail, text])
...
stateDiagram-v2
    ...
    Inicial: 📝 Inicial<br/>Apenas o input visível
    Carregando: ⏳ Carregando<br/>Stepper animado<br/>(6 etapas simuladas)
    Sucesso: ✅ Sucesso<br/>Vídeo + Transcrição<br/>+ Painel mockado
    Erro: ❌ Erro<br/>Mensagem em vermelho
```
